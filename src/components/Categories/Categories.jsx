...
const Categories = ({ title, products = [], amount }) => {
  ...
  return (
    <Stack className="worth-seeing h-auto w-full bg-[#0d1117] rounded-md p-5 gap-5 col-span-full">
      <h2 className="text-center text-amber-50 font-black text-xl">{title}</h2>
